...
public class school implements ischool {
	...
	public int ajouterclasse(classe c) {
		jdbc.connect();
		int nb =jdbc.Maj("insert into classe (school , niveau , filiere , matiere ,idp) values ('"+c.getSchool()+"','"+c.getNiveau()+"','"+c.getFiliere()+"','"+c.getMatiere()+"', -1)");
		jdbc.disconnect();
		return nb ;
	}
	...
	public int modifierclasse(classe c) {
		...
		int nb=jdbc.Maj("update classe set school = '"+c.getSchool()+"' , niveau = '"+c.getNiveau()+"' , filiere = '"+c.getFiliere()+"' , matiere = '"+c.getMatiere()+"' , idp = "+id+" where id = "+c.getId()+" ");
		jdbc.disconnect();
		return nb;
	}
	...
	public int setpaiment(int ide, int ida) {
		jdbc.connect();
		LocalDate d= LocalDate.now();
		int nb=jdbc.Maj("update tabinscrir set payement = 1 , datepaiment = '"+d+"' where ida = "+ida+" and ide = "+ide);
		jdbc.disconnect();
		return nb ;
	}
	...
	public int changepassetu(String pass, int ide) {
		int nb=0;
		jdbc.connect();
		nb=jdbc.Maj("update etudiant set pass = '"+pass+"' where id = "+ide);
		jdbc.disconnect();
		return nb;
	}
	...
	public int changepassad(String pass, int ida) {
		int nb=0;
		jdbc.connect();
		nb=jdbc.Maj("update admine set pass = '"+pass+"' where id = "+ida);
		jdbc.disconnect();
		return nb;
	}
	...
	public int changepassprof(String pass, int idp) {
		int nb=0;
		jdbc.connect();
		nb=jdbc.Maj("update prof set pass = '"+pass+"' where id = "+idp);
		jdbc.disconnect();
		return nb;
	}
